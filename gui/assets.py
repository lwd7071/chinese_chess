...
def _download_all():
    ...
    cache_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "assets_cache")
...
def get_asset(name):
    ...
    if name == "custom_board":
        custom_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "image_readme", "image.png")
