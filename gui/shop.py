...
class ShopScreen:
    ...
    def draw(self, surface, controller):
        ...
        surface.blit(back_txt, (self.btn_back.centerx - back_txt.get_width() // 2, self.btn_back.centery - back_txt.get_height() // 2))
        ...
        sub_txt = self.body_font.render("Trang hoàng kỳ đài, khẳng định đẳng cấp. Khám phá những tuyệt tác thủ công dành riêng cho Kỳ Vương.", True, COLOR_MUTED)
        ...
        div_y = 185
        pygame.draw.line(surface, COLOR_OUTLINE, (div_x, div_y), (div_x + div_w, div_y), 1)
        ...
        pygame.draw.line(surface, COLOR_OUTLINE, (170, sec1_y + 14), (self.width - 80, sec1_y + 14), 1)
        ...
        pygame.draw.line(surface, COLOR_OUTLINE, (185, sec2_y + 14), (self.width - 80, sec2_y + 14), 1)
    ...
    def draw_item_card(self, surface, x, y, item, controller):
        ...
        border_color = COLOR_GOLD if is_equipped else (COLOR_OUTLINE if is_owned else (50, 35, 30))
            ...
            if item["type"] == "board":
                if item["id"] == "classic_wood":
                    ...
                    for py in range(preview_rect.y + 4, preview_rect.bottom - 4, 10):
                        pygame.draw.line(surface, (120, 75, 35), (preview_rect.x + 10, py), (preview_rect.right - 10, py), 1)
                    pygame.draw.rect(surface, (90, 50, 15), (preview_rect.centerx - 30, preview_rect.centery - 30, 60, 60), 1)
                    pygame.draw.line(surface, (90, 50, 15), (preview_rect.centerx, preview_rect.centery - 30), (preview_rect.centerx, preview_rect.centery + 30), 1)
                    pygame.draw.line(surface, (90, 50, 15), (preview_rect.centerx - 30, preview_rect.centery), (preview_rect.centerx + 30, preview_rect.centery), 1)
                    ...
                    for _ in range(5):
                        ...
                        pygame.draw.line(surface, (190, 190, 190), (x1, y1), (x2, y2), 2)
                    random.seed()
                    pygame.draw.rect(surface, COLOR_GOLD, (preview_rect.centerx - 30, preview_rect.centery - 30, 60, 60), 1)
                elif item["id"] == "dark_glass":
                    pygame.draw.rect(surface, (10, 15, 25), preview_rect, 0, 6)
                    pygame.draw.rect(surface, (0, 180, 255), (preview_rect.centerx - 30, preview_rect.centery - 30, 60, 60), 1)
                    pygame.draw.line(surface, (0, 180, 255), (preview_rect.centerx - 30, preview_rect.centery - 30), (preview_rect.centerx + 30, preview_rect.centery + 30), 1)
                    pygame.draw.line(surface, (0, 180, 255), (preview_rect.centerx + 30, preview_rect.centery - 30), (preview_rect.centerx - 30, preview_rect.centery + 30), 1)
            else: # piece
                px, py = preview_rect.centerx, preview_rect.centery
                r = 28
        ...
        if is_equipped:
            ...
            surface.blit(lbl_txt, (lbl_bg.centerx - lbl_txt.get_width() // 2, lbl_bg.centery - lbl_txt.get_height() // 2))
        elif is_owned:
        ...
        # 2. Text Info
        name_txt = self.item_name_font.render(item["name"], True, COLOR_GOLD if is_equipped else COLOR_TEXT)
